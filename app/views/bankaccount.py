...
def read_bankaccount(bankaccount_id: int, db: Session = Depends(get_db)):
...
def update_bankaccount_view(bankaccount_id: int, bankaccount: BankAccountSchema, db: Session = Depends(get_db)):
...
def delete_bankaccount_view(bankaccount_id: int, db: Session = Depends(get_db)):
